...
const PromotionsCarrousel = () => {
    ...
    return (
        <div ref={carouselRef} className="relative w-full h-full mt-10">
                                ...
                                <div className="flex flex-col grow p-4">
                                            ...
                                            {product.sizes?.length > 0 ? (
                                                product.sizes.map((size) => (
                                                    <button
                                                        ...
                                                        className={`px-3 py-1 text-sm rounded-full border ${selectedSizes[product.codigo] === size
                                                ...
                                                <span className="text-sm text-gray-500">Sin tamaños disponibles</span>
                                            )}
                                        </div>
                                    ...
                                    <div className="mt-auto pt-4">
                                        <div className="flex items-center justify-between">
                                            <span className="text-2xl font-bold text-gray-800 pr-4">G$ {formatGuarani(product.precio)}</span>
