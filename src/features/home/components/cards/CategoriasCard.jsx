                            ...
                            >
                                <div className="relative z-10 h-full flex">
                                    <div className="flex flex-col items-start justify-end">
                                        ...
                                        <p className={`${category.descriptionColor} text-2xl font-bold`}>{category.description}</p>
                                        <p className="text-white">Total de productos: 85</p>
                                        <button className={`bg-white ${category.textColor} px-4 py-1 rounded-full hover:bg-orange-100 transition-colors mt-2 font-poppins`}>
                                            Ver más
                                        </button>
                                    </div>
