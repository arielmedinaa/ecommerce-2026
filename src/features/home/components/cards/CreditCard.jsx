        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 mb-6 md:mb-0 md:pr-6">
            ...
            <p className="mb-6 opacity-90">
              Gana 3% de reembolso en todas tus compras en Central Shop y acumula puntos en cada compra.
            </p>
          ...
          <div className="w-full md:w-1/2 relative">
            <img
              ...
              className="relative w-full max-w-none md:max-w-[600px] h-auto transform transition-transform duration-500 hover:scale-105"
            />
          </div>
        </div>
      </div>
